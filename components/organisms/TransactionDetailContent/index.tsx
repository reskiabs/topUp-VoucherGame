          ...
          <div className="main-content main-content-card overflow-auto">
            <section className="checkout mx-auto">
              ...
              <div className="payment pt-10 pb-10">
                ...
                <Row label="Your Account Name" value="Masayoshi Abbas Zero" />
                <Row label="Type" value="ShopeePay" />
                <Row label="Bank Name" value="Bank Central Asia" />
                <Row label="Bank Account Name" value="PT. StoreGG Indonesia" />
                <Row label="Bank Number" value="1112 - 9999 - 1477" />
              </div>
